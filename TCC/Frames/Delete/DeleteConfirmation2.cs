...
namespace TCC.Frames.Delete
{
    public partial class DeleteConfirmation2 : Form
    {
        ...
        public static DeleteConfirmation2 DeleteConfirmFrame;
        ...
        public DeleteConfirmation2(string Tipo, List<string> AllNames)
        {
            InitializeComponent();
            SetColor();
        ...
        private void DeleteConfirmation2_Load(object sender, EventArgs e)
        {
            GifTimer.Start();
            LoadImages();

            if (DeleteType == "Produtos")
                Texto.Text = "Por motivos de segurança, insira a senha para excluir estes produtos.";
            else if (DeleteType == "EntradaItens" || DeleteType == "SaidaItens")
                Texto.Text = "Por motivos de segurança, insira a senha para excluir estes itens.";
        }
        ...
        {
            DeleteConfirmation2 DeleteConfirmationForm = (DeleteConfirmation2)Application.OpenForms["DeleteConfirmation2"];

            List<string> id = Names.Distinct().ToList();

            if (DeleteType == "Produtos")
            {
                if (Password.Text == "DeleteProdutos")
                {
                    GifTimer2.Start();
                    LoadImages2();
                    ...
                    {
                        OleDbCommand cmd = new OleDbCommand("DELETE * FROM Estoque WHERE PRODUTO = @PRODUTO ", con);

                        cmd.CommandType = CommandType.Text;
                        cmd.Parameters.AddWithValue("@PRODUTO", id[i]);
                        ...
                        try
                        {
                            ...
                            {
                                if (frm.Name == "DeleteConfirmation2")
                                    frm.Opacity = .0d;
                            }

                            Success.SuccessFrame.LblText.Text = "Produtos excluídos com sucesso!";
                            SuccessForm.Text = "Produtos excluídos com sucesso!";
                        ...
                        catch (Exception exc)
                        {
                            ...
                            Erro.ErrorFrame.LblText.Text = "Erro ao excluir produtos!";
                            ErrorForm.Text = "Erro ao excluir produtos!";
            ...
            else if (DeleteType == "EntradaItens")
            {
                if (Password.Text == "DeleteEntradaItem")
                {
                    GifTimer2.Start();
                    LoadImages2();
                    ...
                    for (int i = 0; i < Names.Count; i++)
                    {
                        OleDbCommand cmd = new OleDbCommand("DELETE * FROM EntradaDeItens WHERE PRODUTO = @PRODUTO ", con);
                        ...
                        try
                        {
                            ...
                            Success.SuccessFrame.LblText.Text = "Itens excluídos com sucesso!";
                            SuccessForm.Text = "Itens excluídos com sucesso!";
                        ...
                        catch (Exception exc)
                        {
                            ...
                            Erro.ErrorFrame.LblText.Text = "Erro ao excluir itens!";
                            ErrorForm.Text = "Erro ao excluir itens!";
            ...
            else if (DeleteType == "SaidaItens")
            {
                if (Password.Text == "DeleteSaidaItem")
                {
                    GifTimer2.Start();
                    LoadImages2();
                    ...
                    for (int i = 0; i < Names.Count; i++)
                    {
                        OleDbCommand cmd = new OleDbCommand("DELETE * FROM SaidaDeItens WHERE PRODUTO = @PRODUTO ", con);
