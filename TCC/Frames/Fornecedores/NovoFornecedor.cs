...
namespace TCC.Frames
{
    public partial class NovoFornecedor : Form
    {
        ...
        private void NovoCliente_Load(object sender, EventArgs e)
        {
            ...
            UltimaCompra.Value = Convert.ToDateTime(DateTime.Today);
            ...
            foreach (Form frm in fc)
            {
                ...
                else
                {
                    ...
                    if (TextoChanged)
                    {
                        ...
                        Frames.CloseConfirm.CloseFrame.LblText.Text = "Você deseja mesmo cancelar o cadastro de novo fornecedor?";
                    }
                }
        ...
        private void AddControlsToList()
        {
            ...
            {
                label1, label2, label3, label4, label6, label7, label8, label9, label10, label11, label12, label13,
                label14, label15, label16, label21, label22
            };
            ...
            {
                Cancelar1, Cancelar2, Cancelar4, Anterior1, Anterior3
            };
            ...
            {
                NomeHint, TelefoneHint, TipoNumeroHint, CpfHint, EnderecoHint, CidadeHint, EstadoHint
            };
            ...
            if (Nome.Text != "" && Telefone.Text != "" && Pessoa.SelectedIndex != -1 && TipoNumero.SelectedIndex != -1)
            {
                if (CPFCNPJ.Text != "" && Pessoa.SelectedIndex == 0 && CPFCNPJ.Text.Length == 14 || CPFCNPJ.Text != "" && Pessoa.SelectedIndex == 1 && CPFCNPJ.Text.Length == 18)
                {
                    if (Telefone.Text != "" && TipoNumero.SelectedIndex == 0 && Telefone.Text.Length == 15 || Telefone.Text != "" && TipoNumero.SelectedIndex == 1 && Telefone.Text.Length == 9)
                    {
                        ...
                        OleDbCommand cmd = new OleDbCommand("SELECT COUNT (*) FROM Fornecedores WHERE (NOME = @NOME)", con);
                        ...
                        if (ExistItem > 0)
                        {
                            ...
                            Alerta.AlertaFrame.LblText.Text = "Já existe um fornecedor com este nome cadastrado no sistema!";
        ...
        private void Concluir_Click_1(object sender, EventArgs e)
        {
            ...
            string comando =
                ...
                // Campos
                "INSERT INTO Fornecedores (NOME, TELEFONE, CPFCNPJ, INSCESTADUAL, PESSOA, ENTRADA, \n" +
                "ENDERECO, BAIRRO, CIDADE, CEP, ESTADO, COMPLEMENTO, OBSERVACOES, EMAIL, ULTIMACOMPRA, FOTO," +
                "TRANSPORTADORA) \n" +


                // Valores
                "values (@NOME, @TELEFONE, @CPFCNPJ, @INSCESTADUAL, @PESSOA, @ENTRADA, \n" +
                "@ENDERECO, @BAIRRO, @CIDADE, @CEP, @ESTADO, @COMPLEMENTO, @OBSERVACOES, @EMAIL, @ULTIMACOMPRA, @FOTO," +
                "@TRANSPORTADORA)";
            ...
            com.Parameters.Add("@INSCESTADUAL", OleDbType.VarChar).Value = InscEstadual.Text;
            ...
            com.Parameters.Add("@ULTIMACOMPRA", OleDbType.Date).Value = UltimaCompra.Value.ToLongDateString();
            ...
            com.Parameters.Add("@TRANSPORTADORA", OleDbType.Boolean).Value = IsT;
            ...
            try
            {
                ...
                AddSuccess.SuccessAdd.LblText.Text = "Fornecedor cadastrado com sucesso!";
            ...
            catch (Exception exc)
            {
                ...
                ErrorForm.Text = "Erro";
                Erro.ErrorFrame.LblText.Text = "Erro ao cadastrar fornecedor!";
